  ...
  return (
    <>
      <div className="container-testimonial">
        <h1 className="green center">See What People are Saying About Us!</h1>
        <p className="center">
          We aim to provide guidance and success hacks to NEET | IIT-JEE
          aspirants and exciting Mentorship opportunities to toppers of these
          exams... but just don't take our word for it.
        </p>
